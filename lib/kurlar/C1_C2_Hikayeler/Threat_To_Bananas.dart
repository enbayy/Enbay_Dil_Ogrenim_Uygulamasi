...
import 'package:muhtasarim/kurlar/C1_C2_Hikayeler/Threat_To_Bananas_ceviri.dart';

class Threat_To_Bananas extends StatefulWidget {

  @override
  _Threat_To_BananasState createState() => _Threat_To_BananasState();
}

class _Threat_To_BananasState extends State<Threat_To_Bananas> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Threat To Bananas'),
      ),
      body: Center(
