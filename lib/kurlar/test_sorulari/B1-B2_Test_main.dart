...
import 'package:muhtasarim/kurlar/test_sorulari/B1-B2_Coktan_Secmeli.dart';

void main() {
  runApp(const B1_B2_CoktanSecmeli());
}

class B1_B2_CoktanSecmeli extends StatefulWidget {
  const B1_B2_CoktanSecmeli({Key? key}) : super(key: key);

  @override
  _B1_B2_CoktanSecmeliState createState() => _B1_B2_CoktanSecmeliState();
}

class _B1_B2_CoktanSecmeliState extends State<B1_B2_CoktanSecmeli> {
  @override
                    ...
                    child: Padding(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            ...
                            side: const BorderSide(color: Colors.teal, width: 8),
