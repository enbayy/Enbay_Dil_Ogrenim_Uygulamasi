...
import 'package:muhtasarim/kurlar/test_sorulari/C2_Coktan_Secmeli.dart';

void main() {
  runApp(const C2_CoktanSecmeli());
}

class C2_CoktanSecmeli extends StatefulWidget {
  const C2_CoktanSecmeli({Key? key}) : super(key: key);

  @override
  _C2_CoktanSecmeliState createState() => _C2_CoktanSecmeliState();
}

class _C2_CoktanSecmeliState extends State<C2_CoktanSecmeli> {
  @override
