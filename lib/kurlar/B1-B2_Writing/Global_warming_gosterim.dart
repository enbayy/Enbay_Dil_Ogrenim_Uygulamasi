...
class Global_warming_gosterim extends StatelessWidget {

  String metin;

  Global_warming_gosterim({required this.metin});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Metin Önizleme',),backgroundColor: Colors.teal,),
